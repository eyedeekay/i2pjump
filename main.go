...
var (
	name      = flag.String("name", "jumphelp", "Name to use for your Jump server")
	...
	announce  = flag.String("announce", "", "Comma-separated list of other I2PJump-based jump services to \"announce\" ourselves to for publicity purposes.")
)
